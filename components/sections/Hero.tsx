...
export function Hero() {
  return (
    <section className="relative isolate overflow-x-hidden pt-24 pb-16 sm:pb-24">
      <ParticleNetwork />
      <div className="pointer-events-none absolute -left-24 top-24 h-72 w-72 animate-orb-1 rounded-full bg-blue/30 blur-[100px]" />
      <div className="pointer-events-none absolute right-0 top-40 h-80 w-80 animate-orb-2 rounded-full bg-violet/25 blur-[110px]" />
      <div className="pointer-events-none absolute bottom-10 left-1/3 h-64 w-64 animate-orb-3 rounded-full bg-blue/20 blur-[90px]" />
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        ...
        <div className="relative z-10 max-w-xl lg:pr-4">
          <motion.p
            className="font-display text-[clamp(2.85rem,7vw,4.5rem)] font-extrabold leading-[0.92] tracking-tight"
          ...
          <motion.h1
            className="mt-6 font-display text-[clamp(1.55rem,3.2vw,2.25rem)] font-bold leading-[1.2] tracking-tight text-text-primary"
            initial={{ opacity: 0, y: 18 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="mt-5 max-w-md text-[0.98rem] leading-relaxed text-text-muted sm:text-base"
          ...
          <motion.p
            className="mt-5 text-xs leading-relaxed tracking-wide text-text-muted/90"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
          <div className="pointer-events-none absolute inset-x-10 -bottom-6 h-20 rounded-full bg-blue/30 blur-3xl" />
          <div className="animate-float">
            <GlassCard className="relative overflow-hidden p-4 shadow-blue-glow" glow="blue">
